...
/* ── Component — renders inline, positioned by parent ────────────────── */
...
export default function NewsImageCropper({ file, onDone, onCancel }: Props) {
  ...
  return (
    /* Absolute overlay — fills parent <DialogContent> */
    <div className="absolute inset-0 z-50 flex flex-col rounded-[inherit] overflow-hidden bg-card">
      {/* Header */}
      ...
      {/* Aspect ratio pills */}
      <div className="flex items-center gap-1.5 px-4 py-2 border-b border-border/20 flex-wrap shrink-0">
      ...
      {/* Crop canvas area */}
      <div className="flex-1 flex items-center justify-center bg-black/40 overflow-auto p-3 min-h-0">
        <ReactCrop
          crop={crop}

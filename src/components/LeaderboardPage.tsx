    ...
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="flex-1 min-h-0 overflow-hidden">
        <Tabs defaultValue="contributors" className="flex h-full flex-col">
          ...
          {/* Contributors */}
          <TabsContent value="contributors" className="flex-1 min-h-0 overflow-y-auto mt-0 px-4 pb-6 pt-4 md:px-6">
            <div>
              {loading ? (
          ...
          {/* Articles */}
          <TabsContent value="articles" className="flex-1 min-h-0 overflow-hidden mt-0">
